                    ...
                    <table class="table table-bordered table-light table-striped">
                        ...
                        foreach($inven as $i): ?>
                            <tr class="<?= $i['stok_barang'] == 0 ? 'table-danger' : '' ?>">
                                ...
                                <td><?= $i['lokasi'] ?></td>
                                <td>
                                    <a class="btn btn-warning" href="editinv.php?updateinv=<?= $i['id_inv'] ?>">Edit Inventory</a>
                                    <a class="btn btn-warning" href="inventory.php?deleteinv=<?= $i['id_inv'] ?>" onclick="return confirm('Apakah anda yakin mau delete')">Delete Inventory</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
